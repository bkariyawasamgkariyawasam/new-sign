...
from keras.utils import to_categorical  # type: ignore # For encoding labels
from keras.models import Sequential  # type: ignore # Sequential model architecture
from keras.layers import LSTM, Dense   # type: ignore # Layers for the model
from keras.callbacks import TensorBoard  # type: ignore # For logging and monitoring training progress
import numpy as np
import os
